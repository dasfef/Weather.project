...
def home(request):                          # 홈페이지 구성
    ...
    # vFcst
    vFcst_tbl = Vilagefcst.objects.all()
    ...
    return render(request, "home/index.html", {"Rc1": Rc1, "Rc2": Rc2, "Rc3": Rc3, 'val' : val, "sFcst_tbl" : sFcst_tbl, "sNcst_tbl" : sNcst_tbl, "vFcst_tbl" : vFcst_tbl,
